...
window.onload = () => {  
    if (game_state == true) {
        document.getElementById('start').addEventListener("mouseover", trackMouse);
    }
}
...
function resetGame() {
    ...
    document.getElementById('status').innerHTML = `Begin by moving your mouse over the "S". <br> ${game_score} points`;
    disableEvent();
}
